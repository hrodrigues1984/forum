...
namespace InCloudOut\Toastr\Facades {
    ...
    class Toastr {
        ...
        {
            return \InCloudOut\Toastr\Toastr::execute();
        }
        ...
        {
            return \InCloudOut\Toastr\Toastr::add($type, $message, $title, $options);
        }
        ...
        {
            return \InCloudOut\Toastr\Toastr::info($message, $title, $options);
        }
        ...
        {
            \InCloudOut\Toastr\Toastr::error($message, $title, $options);
        }
        ...
        {
            \InCloudOut\Toastr\Toastr::warning($message, $title, $options);
        }
        ...
        {
            \InCloudOut\Toastr\Toastr::success($message, $title, $options);
        }
        ...
        {
            return \InCloudOut\Toastr\Toastr::clear();
        }
...
namespace {
    ...
    class Toastr extends \InCloudOut\Toastr\Facades\Toastr {}
